    ...
    return (
        <div className='flex w-full'>
            <div className='flex flex-col justify-center items-center lg:w-2/4 mr-10 md:flex-row'>
                <img src={fondoLogin} alt="imagen login" className='relative w-0 md:w-1/2 lg:w-0 sm:w-0'></img>
                <div>
                    ...
                    <form className='p-4 mx-auto w-96 sm:px-9 mt-8 shadow-md'>
                        <div className='mb-5'>
                            ...
                            <input type="email" id="email" className='block placeholder-slate-400 p-2 w-full bg-slate-100' placeholder='admin@gmail'></input>
                        </div>

                        <div className='mb-5'>
                            <label htmlFor='password' className='font-medium'>Password</label>
                            <input type="password" id="password" className='block placeholder-slate-400 p-2 w-full bg-slate-100' placeholder='admin@gmail'></input>
                        </div>
            ...
            <div className='h-full w-0 bg-sky-500 lg:w-full'>
                <img src={imgLogin} alt="imagen login" className='h-full w-screen'></img>
